  ...
  return (
    <div className="">
      ...
      <div className="flex gap-8 mt-7">
        <div className="group border-[1px] border-border h-[155px] w-[350px] rounded-[10px] hover:bg-foreground-primary p-4 cursor-pointer flex flex-col gap-3 transition-all ease-in-out duration-300">
          <div className="flex justify-between items-start">
            <div className="icon-container group-hover:bg-text-primary">
              <EmptyScriptIcon className="text-text-primary group-hover:text-background-primary h-4" />
            </div>
            <AddIcon className="fill-text-secondary w-3 m-1 h-fit group-hover:fill-text-primary" />
          </div>
          <div className="flex flex-col gap-1">
            <span className="font-bold text-text-primary text-base">Blank</span>
        ...
        <div className="group border-[1px] border-border h-[155px] w-[350px] rounded-[10px] hover:bg-foreground-primary p-4 cursor-pointer flex flex-col gap-3 transition-all ease-in-out duration-300">
          <div className="flex justify-between items-start">
            <div className="icon-container group-hover:bg-text-primary">
              <ImportIcon className="text-text-primary group-hover:text-background-primary w-[14px]" />
            </div>
            <AddIcon className="fill-text-secondary w-3 m-1 h-fit group-hover:fill-text-primary" />
          </div>
          <div className="flex flex-col gap-1">
        ...
        <div className="group border-[1px] border-border h-[155px] w-[350px] rounded-[10px] hover:bg-foreground-primary p-4 cursor-pointer flex flex-col gap-3 transition-all ease-in-out duration-300">
          <div className="flex justify-between items-start">
            <div className="icon-container group-hover:bg-text-primary">
              <AiIcon className="text-text-primary group-hover:text-background-primary w-4 h-fit" />
            </div>
            <AddIcon className="fill-text-secondary w-3 m-1 h-fit group-hover:fill-text-primary" />
          </div>
          <div className="flex flex-col gap-1">
